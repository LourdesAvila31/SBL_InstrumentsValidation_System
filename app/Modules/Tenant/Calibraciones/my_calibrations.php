...
<head>
    <meta charset="UTF-8">
    <title>Mis Calibraciones | SBL Pharma</title>
    ...
    <div class="main-content">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <span class="topbar-title">Mis Calibraciones</span>
            </div>
        </div>
        <section class="dashboard-section">
            <h2>
                <?php
                if ($rol == "Operador") echo "Registrar / Editar mis calibraciones";
                elseif ($rol == "Cliente") echo "Ver mis calibraciones";
                elseif ($rol == "Superadministrador") echo "Ver todas las calibraciones";
                ?>
            </h2>
            <!-- Aquí puedes agregar la tabla, formulario o visor de calibraciones según el rol -->
        </section>
    </div>
