...
<head>
    <meta charset="UTF-8">
    <title>Calibraciones | SBL Pharma</title>
    ...
    <div class="main-content">
        <div class="topbar">
            <div class="topbar-left">
                ...
                <span class="topbar-title">Calibraciones</span>
            </div>
        </div>
        <section class="dashboard-section">
            <h2><?php echo in_array($rol, ['Supervisor','Administrador','Superadministrador'], true) ? 'Ver y editar calibraciones' : 'Consultar calibraciones'; ?></h2>
            <!-- Aquí puedes agregar la tabla o formulario de calibraciones según el rol -->
        </section>
    </div>
